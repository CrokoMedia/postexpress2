...
/**
 * Composicao Story (9:16 / 1080x1920) -- usa o mesmo SlideFrame
 * com layout="story" para adaptar tipografia e dimensoes de imagem.
 */
export const StoryReel: React.FC<CarouselReelProps> = ({
  slides,
  profilePicUrl,
  username,
  fullName,
