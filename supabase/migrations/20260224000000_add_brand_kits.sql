...
CREATE UNIQUE INDEX IF NOT EXISTS idx_brand_kits_one_default_per_profile
  ON brand_kits(profile_id)
  WHERE is_default = TRUE AND deleted_at IS NULL;
...
-- 2. Garantir que o primeiro kit é sempre padrão
...
-- 3. Impedir delete do último kit e auto-promover novo padrão
