/**
 * OCR Image Analyzer usando Gemini Vision API
 *
 * Extrai texto de imagens de posts do Instagram usando Google Gemini
 *
 * Uso:
 *   node scripts/ocr-gemini-analyzer.js <username> [--source=posts-with-comments]
 *
 * Exemplos:
 *   node scripts/ocr-gemini-analyzer.js rodrigogunter_
 *   node scripts/ocr-gemini-analyzer.js frankcosta --source=posts-with-comments
 *
 * Saída:
...
/**
 * Analisa uma única imagem usando Gemini Vision
 */
...
async function analyzePostImages(username, options = {}) {
  ...
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  console.log('🔍 OCR IMAGE ANALYZER - Gemini Vision API');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
  ...
  try {
    ...
    // Processar posts
    console.log('🔍 INICIANDO ANÁLISE OCR COM GEMINI...\n');
    ...
    // Salvar resultados
    const outputFile = `${dataDir}/${username}-ocr-gemini-analysis.json`;
    ...
    console.log('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log('📈 RESUMO DA ANÁLISE OCR - GEMINI');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
...
if (!username) {
  ...
  console.log('\nUso: node scripts/ocr-gemini-analyzer.js <username> [--source=arquivo]');
  console.log('\nExemplos:');
  console.log('  node scripts/ocr-gemini-analyzer.js rodrigogunter_');
  console.log('  node scripts/ocr-gemini-analyzer.js frankcosta --source=posts-with-comments');
  process.exit(1);
}
