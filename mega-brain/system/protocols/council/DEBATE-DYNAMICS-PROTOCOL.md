...
> **Dependencias:** DEBATE-PROTOCOL.md, COUNCIL-PROTOCOL.md, CONSTITUICAO-BASE.md
...
> **Configuracao completa:** `/system/protocols/council/DEBATE-DYNAMICS-CONFIG.yaml`
...
DEBATE-DYNAMICS-PROTOCOL
         ...
         │
         ├──► COUNCIL-PROTOCOL.md (escalacao para meta-avaliacao)
         │
...
4. COUNCIL-PROTOCOL.md       → Define meta-avaliacao
