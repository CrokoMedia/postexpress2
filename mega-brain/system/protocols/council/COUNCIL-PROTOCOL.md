...
> **Versao:** 2.0.0
> **Trigger:** Comando /council ou decisao de alto risco
...
> **Template de Log:** COUNCIL-LOG-TEMPLATE-v2.md
...
|-----------|------|--------|
| CONSTITUICAO-BASE | `/system/protocols/CONSTITUICAO-BASE.md` | **INVOCADA PRIMEIRO** - Principios fundamentais |
| COUNCIL-LOG-TEMPLATE-v2 | `./COUNCIL-LOG-TEMPLATE-v2.md` | Template com dialogos naturais |
...
```yaml
# agents/council/DEVILS-ADVOCATE.md
