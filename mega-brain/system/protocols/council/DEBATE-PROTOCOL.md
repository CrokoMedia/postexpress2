...
| COUNCIL-PROTOCOL | `./COUNCIL-PROTOCOL.md` | Meta-avaliacao pelo Conselho |
| CONSTITUICAO-BASE | `/system/protocols/CONSTITUICAO-BASE.md` | Principios fundamentais |
