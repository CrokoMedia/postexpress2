...
│                                                                             │
│  Ver: /system/protocols/PIPELINE/NARRATIVE-METABOLISM-PROTOCOL.md                 │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
**Ver:** `/system/protocols/PIPELINE/SOURCES-COMPILATION-PROTOCOL.md`
...
[ ] CP-4.0.A: NARRATIVES-STATE.json existe em /processing/narratives/
...
```
/system/protocols/PIPELINE/SOURCES-COMPILATION-PROTOCOL.md
```
