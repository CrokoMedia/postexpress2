...
> **Output:** `/processing/canonical/CANONICAL-MAP.json` + chunks atualizados
...
[ ] CP-1.2.A: CHUNKS-STATE.json existe em /processing/chunks/
...
Arquivo: `/processing/canonical/CANONICAL-MAP.json`
...
1. Atualizar: `/processing/canonical/CANONICAL-MAP.json`
2. Atualizar: `/processing/chunks/CHUNKS-STATE.json` (com entidades canonicalizadas)
