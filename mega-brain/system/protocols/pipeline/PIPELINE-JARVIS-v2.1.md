...
│                                                                              │
│  ⛔ ENFORCEMENT INTEGRADO: Ver /system/protocols/SYSTEM/ENFORCEMENT.md    │
│  📋 LOGS OBRIGATÓRIOS: Ver /system/protocols/SYSTEM/LOG-TEMPLATES.md      │
│                                                                              │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
|---------|------|-------------|
| ENFORCEMENT.md | `/system/protocols/SYSTEM/` | ✅ |
| CHECKPOINT-ENFORCEMENT.md | `/system/protocols/SYSTEM/` | ✅ |
| LOG-TEMPLATES.md | `/system/protocols/SYSTEM/` | ✅ |
| PROMPT-1.1-CHUNKING.md | `/system/protocols/PIPELINE/` | ✅ |
| PROMPT-1.2-ENTITY-RESOLUTION.md | `/system/protocols/PIPELINE/` | ✅ |
| PROMPT-2.1-INSIGHT-EXTRACTION.md | `/system/protocols/PIPELINE/` | ✅ |
| PROMPT-2.1-DNA-TAGS-INCREMENT.md | `/system/protocols/PIPELINE/` | ✅ |
| PROMPT-3.1-NARRATIVE-SYNTHESIS.md | `/system/protocols/PIPELINE/` | ✅ |
| DOSSIER-COMPILATION-PROTOCOL.md | `/system/protocols/PIPELINE/` | ✅ |
| SOURCES-COMPILATION-PROTOCOL.md | `/system/protocols/PIPELINE/` | ✅ |
| NARRATIVE-METABOLISM-PROTOCOL.md | `/system/protocols/PIPELINE/` | ✅ |
| DNA-EXTRACTION-PROTOCOL.md | `/system/protocols/dna/` | ✅ |
| ENRICHMENT-PROTOCOL.md | `/system/protocols/dna/` | ⚪ Opcional |
| REASONING-MODEL-PROTOCOL.md | `/system/protocols/dna/` | ⚪ Opcional |
| TEMPLATE-EVOLUTION-PROTOCOL.md | `/agents/protocols/` | ✅ (Phase 7) |
...
```
APPLY protocol from /system/protocols/PIPELINE/PROMPT-1.1-CHUNKING.md
...
```
APPLY protocol from /system/protocols/PIPELINE/PROMPT-1.2-ENTITY-RESOLUTION.md
...
WRITE /processing/chunks/CHUNKS-STATE.json
WRITE /processing/canonical/CANONICAL-MAP.json
...
```
APPLY protocol from /system/protocols/PIPELINE/PROMPT-2.1-INSIGHT-EXTRACTION.md
...
```
APPLY protocol from /system/protocols/PIPELINE/PROMPT-3.1-NARRATIVE-SYNTHESIS.md
...
### 5.2 - Save Narratives
```
WRITE /processing/narratives/NARRATIVES-STATE.json
```
  ...
  IF conteúdo NÃO CABE:
    IF relevante para MÚLTIPLOS agentes (>1):
      IF substância suficiente (>3 insights OU 1 framework):
        ...
        → Aplicar /agents/protocols/TEMPLATE-EVOLUTION-PROTOCOL.md
