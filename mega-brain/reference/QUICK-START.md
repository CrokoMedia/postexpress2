...
cp ~/Documents/processos-internos/*.pdf 00-raw-materials/INTERNO-THIAGO/pdfs/
cp ~/gravacoes/*.mp4 00-raw-materials/INTERNO-THIAGO/videos/
```
...
./00-raw-materials/TRANSCRIBE-AND-CATALOG.sh INTERNO-THIAGO
...
Prioridade:
1. INTERNO-THIAGO (contexto primário)
2. HORMOZI
3. CALL-FUNNEL
...
```
"MASTER AGENT, processe todos os materiais de INTERNO-THIAGO"
```
...
| Processar INTERNO-THIAGO | 2-3h | ✅ Sim (MASTER AGENT) |
