---
description: Cria novo agente quando role-tracking atinge threshold
argument-hint: [NOME] --category [SALES|OPERATIONS|C-LEVEL] [--sub-of AGENT] [--expertise "..."]
---
...
```
/create-agent [NOME] [FLAGS]
```

| Flag | Descrição | Obrigatório |
|------|-----------|-------------|
| `--category` | SALES, OPERATIONS, C-LEVEL | ✅ |
| `--sub-of` | Agente pai na hierarquia | ❌ |
