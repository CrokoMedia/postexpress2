...
## Exemplos
```
/council "Mudar modelo de comissao de closers de 10% para 15%?"
/council "Investir R$500k em expansao de time no Q1?"
```
...
Seguir /system/protocols/council/COUNCIL-PROTOCOL.md
...
Carregar /agents/council/CRITIC.md e aplicar:
...
Carregar /agents/council/DEVILS-ADVOCATE.md e aplicar:
...
Carregar /agents/council/SYNTHESIZER.md e aplicar:
