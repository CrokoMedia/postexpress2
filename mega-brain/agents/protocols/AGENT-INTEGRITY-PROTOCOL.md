...
|----------|-------------|--------|-----------|
| **SOUL-TEMPLATE.md** | `/agents/protocols/SOUL-TEMPLATE.md` | v2.0 | Identidade viva do agente |
| **MEMORY-PROTOCOL.md** | `/agents/protocols/MEMORY-PROTOCOL.md` | v2.0.0 | Experiência acumulada |
| **DNA-CONFIG-TEMPLATE.yaml** | `/agents/protocols/DNA-CONFIG-TEMPLATE.yaml` | v2.0.0 | Configuração de fontes |
