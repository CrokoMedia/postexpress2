...
async function generateCarousel() {
  ...
  console.log('🚀 Gerando Carrossel #7 "Framework de 1 Sentença" com Playwright\n');
  ...
  try {
    ...
    console.log('  2. Testar upload no Cloudinary');
    console.log('  3. Integrar com Content Squad\n');
