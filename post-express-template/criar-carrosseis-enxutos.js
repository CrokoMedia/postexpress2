/**
 * Criar 9 Carrosséis ENXUTOS
 * Máximo 5 slides cada
 * 3-4 linhas por slide
 */
...
const carrossel3 = {
  ...
  slides: [
    {
      texto: `3 frameworks que aprendi
auditando minha conta.
...
Sistema de IA que faz
empresas faturarem +30%
em 90 dias
...
const carrossel5 = {
  ...
  slides: [
    {
      texto: `Nunca contei como faturei
8 empresas de 1 bilhão.
...
É ter um SISTEMA que
multiplica seu resultado.`
    },
    {
      texto: `QUER O SISTEMA
TURBINADO POR IA?
...
const carrossel8 = {
  ...
  slides: [
    {
      texto: `Você curte posts motivacionais
mas nunca muda nada?
...
// Salvar todos
const outputDir = path.join(__dirname, '../squad-auditores/output-enxutos');
...
console.log('🚀 Criando 9 carrosséis ENXUTOS\n');
console.log('📐 Máximo 5 slides por carrossel\n');

let totalSlides = 0;

carrosseis.forEach(carrossel => {
  const filename = `carrossel_${carrossel.numero}_enxuto.json`;
...
console.log('═══════════════════════════════════════\n');
console.log('🎉 9 CARROSSÉIS ENXUTOS CRIADOS!\n');
console.log(`📊 Total de slides: ${totalSlides}`);
console.log(`📁 Pasta: squad-auditores/output-enxutos/\n`);
console.log('💡 Agora sim! Nada de Netflix aqui 😄\n');
